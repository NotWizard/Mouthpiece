...
async function main() {
  ...
  const mockRelease = {
    ...
    html_url: "https://github.com/NotWizard/Mouthpiece/releases/tag/v-test-fallback",
    assets: [
      {
        name: "dummy.zip",
        browser_download_url:
          "https://github.com/NotWizard/Mouthpiece/releases/download/v-test-fallback/dummy.zip",
      },
    ],
  };
  ...
  try {
    const release = await fetchLatestRelease("NotWizard/Mouthpiece");
